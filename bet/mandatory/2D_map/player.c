...
/*   Updated: 2025/03/26 00:38:31 by ykamboua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void update_player_p(mlx_key_data_t key, void *param)
{
	...
	// printf("movex %f movey %f strafex %f strafey %f \n", move_x, move_y, strafe_x, strafe_y);
	...
	// printf("movex %f movey %f strafex %f strafey %f \n", new_x, new_y, strafe_x, strafe_y);

	printf("_HORIZAONTA x %d HORIZONTAL Y %d \n\n", map->texture.horizontal_hit_x, map->texture.horizontal_hit_y);
